...
const navLinks = [
  { label: "Candidates", href: "#careers", active: true },
  { label: "Companies", href: "#mobility", active: false },
  { label: "Pricing", href: "#cta", active: false },
  { label: "About", href: "#footer", active: false },
];
    ...
    <header className="sticky top-0 z-50 border-b border-[#edd8d4] bg-white/95 backdrop-blur-sm">
      <nav className="mx-auto flex h-20 w-full max-w-[1440px] items-center justify-between px-4 sm:px-6 lg:px-10">
        <div className="flex items-center gap-8">
          <Link to="/home" className="text-[28px] font-extrabold tracking-[-0.04em] text-[#b90014] md:text-[34px]">
            RecruitPro
          </Link>
